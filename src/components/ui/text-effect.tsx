...
> = {
  blur: {
    ...
    item: {
      ...
      visible: { opacity: 1, filter: 'blur(0px)', y: 0, transition: { duration: 0.45, ease: [0.2, 0.65, 0.3, 0.9] } },
...
export function TextEffect({
  ...
  const MotionTag = ((motion as unknown as Record<string, React.ElementType>)[as as string] || motion.p) as React.ElementType;
